...
class OneReviewDesc {
  ...
  changeDescTitleNumber(next) {
    if (next) {
      if (this.descTitleNumber + 1 >= this.descTitle.length) {
        return false;
      }
      else {
  ...
  changeActiveBenefitObjectNumber(next) {
    if (next) {
      if (this.activeBenefitObjectNumber + 1 >= this.saleDescription.length - 1) {
        return false;
      }
      else {
        this.activeBenefitObjectNumber++;
      }
    } else {
      if (this.activeBenefitObjectNumber - 1 < 0) {
        return false;
      }
      else {
        this.activeBenefitObjectNumber--;
  ...
  changeActiveBenefitNumber(next) {
    if (next) {
      if (this.activeBenefitNumber + 1 >= this.saleDescription.length - 1) {
        return false;
      }
      else {
        this.activeBenefitNumber++;
      }
    } else {
      if (this.activeBenefitNumber - 1 < 0) {
        return false;
      }
      else {
        this.activeBenefitNumber--;
