...
export const saleDescription = [
    ...
    {name:'Конструкция и сохранность', value:[
    ...
    {name:'Участки - только для загородки', value:[
    ...
    {name:'Портик, дворик, беседка, веранда, бассейн, гаражи, забор - только для загородки', value:[
